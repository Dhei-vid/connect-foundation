...
import { updateVolunteerOpportunity } from "@/firebase/volunteer-opportunities";
import { toast } from "sonner";
import type { VolunteerOpportunity } from "@/common/types";

interface EditVolunteerOpportunityModalProps {
  children: React.ReactNode;
  opportunity: VolunteerOpportunity;
  onSuccess: () => void;
}

export function EditVolunteerOpportunityModal({
  children,
  opportunity,
  onSuccess,
}: EditVolunteerOpportunityModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.description || !formData.timeCommitment || !formData.location) {
      toast.error("Error", {
    ...
    try {
      ...
      await updateVolunteerOpportunity(opportunity.id, {
        ...formData,
