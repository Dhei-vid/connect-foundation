...
export const mockOrphanages: Orphanage[] = [
  {
    ...
    state: "Lagos",
    city: "Ikeja",
    description: "A caring home providing shelter, education, and love to orphaned children since 2010. We focus on holistic development and preparing children for successful futures.",
    contactEmail: "info@hopechildrenshome.org",
    contactPhone: "+234 801 234 5678",
    website: "https://hopechildrenshome.org",
    logoURL: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=400&auto=format&fit=crop&q=60",
  ...
  },
  {
    ...
    state: "FCT",
    city: "Garki",
    description: "Committed to providing quality education and healthcare to vulnerable children. Our mission is to ensure every child has a bright future ahead.",
    contactEmail: "contact@brightfuture.org",
    contactPhone: "+234 802 345 6789",
    logoURL: "https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=400&auto=format&fit=crop&q=60",
    coverImageURL: "https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=1200&auto=format&fit=crop&q=80",
    images: [
  ...
  },
  {
    ...
    state: "Rivers",
    city: "Port Harcourt",
    description: "Dedicated to rescuing and rehabilitating abandoned children. We provide medical care, education, and emotional support to help children thrive.",
    contactEmail: "info@gracefoundation.org",
    contactPhone: "+234 803 456 7890",
    logoURL: "https://images.unsplash.com/photo-1529390079861-591de354faf5?w=400&auto=format&fit=crop&q=60",
    coverImageURL: "https://images.unsplash.com/photo-1529390079861-591de354faf5?w=1200&auto=format&fit=crop&q=80",
    images: [
  ...
  },
  {
    ...
    state: "Kano",
    city: "Nassarawa",
    description: "A safe haven for orphaned and vulnerable children. We focus on education, skill development, and creating a loving family environment.",
    contactEmail: "contact@littleangels.org",
    contactPhone: "+234 804 567 8901",
    logoURL: "https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=400&auto=format&fit=crop&q=60",
    coverImageURL: "https://images.unsplash.com/photo-1544776193-352d25ca82cd?w=1200&auto=format&fit=crop&q=80",
    images: [
...
export const mockSuccessStories: SuccessStory[] = [
  ...
  },
  {
    ...
    description: "Bright Future Orphanage received funding to build a state-of-the-art computer lab with 50 computers, high-speed internet, and educational software. The project also included training for staff and students on digital literacy, coding, and online learning platforms. This has opened up a world of opportunities for children who previously had no access to technology.",
    impact: "The digital education lab has revolutionized learning at Bright Future Orphanage. All 200 children now have access to computers and the internet, enabling them to develop crucial 21st-century skills. Students have completed over 1,000 online courses, learned basic coding, and improved their academic performance by 40%. Several older students have already secured internships with tech companies. The lab also hosts weekend coding clubs and has become a community resource center.",
    images: [
  ...
  },
  {
    ...
    description: "Little Angels Home built a multi-purpose sports complex including a football field, basketball court, playground equipment, and covered recreation area. The project also provided sports equipment, uniforms, and coaching from professional trainers. Regular sports activities, tournaments, and physical education classes are now part of the daily routine.",
    impact: "The sports complex has transformed physical and mental health at Little Angels Home. Physical fitness levels have improved significantly, with obesity rates dropping from 25% to 5%. Children participate in organized sports daily, developing teamwork, discipline, and leadership skills. The orphanage football team won the regional championship, boosting confidence and pride. Sports have provided a positive outlet for energy and emotions, reducing behavioral issues by 70%. Inter-orphanage tournaments have created friendships and networks. Several talented athletes have been scouted for sports academies.",
    images: [
      "https://images.unsplash.com/photo-1529390079861-591de354faf5?w=800&auto=format&fit=crop&q=80",
...
export const mockSuccessStoryStats = {
  ...
  totalBeneficiaries: mockSuccessStories.reduce((sum, story) => sum + story.beneficiaries, 0),
...
export const getMockOrphanageById = (id: string): Orphanage | null => {
...
export const getMockSuccessStories = (filters?: {
  ...
  if (filters?.orphanageId) {
    stories = stories.filter(story => story.orphanageId === filters.orphanageId);
  }
