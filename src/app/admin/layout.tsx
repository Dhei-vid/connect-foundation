...
const adminNavItems = [
  ...
  { label: "Orphanages", href: "/admin/orphanages", icon: Building2 },
  { label: "Success Stories", href: "/admin/success-stories", icon: Heart },
  { label: "Issues & Requests", href: "/admin/issues", icon: AlertTriangle },
  { label: "Donations", href: "/admin/donations", icon: DollarSign },
  { label: "Financial Records", href: "/admin/financial", icon: BarChart3 },
  { label: "Contact Inquiries", href: "/admin/contact", icon: MessageSquare },
