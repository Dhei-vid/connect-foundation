    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockStats.totalOrphanages}</div>
            <p className="text-xs text-muted-foreground">
              {mockStats.verifiedOrphanages} verified, {mockStats.pendingVerification} pending
            </p>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Hope Children&apos;s Home</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Grace Orphanage</p>
                </div>
                <Button size="sm" variant="destructive">View</Button>
              </div>
            </div>
